  ...
  chapters: [
    {
      ...
      summary: 'Generate a wide range of ideas and explore inspiration.',
      description:
    ...
    {
      title: 'Idea Grouping and Categorization',
      summary: 'Organize ideas into themes or categories.',
      description:
    ...
    },
    {
      ...
      summary: 'Select promising ideas and refine them further.',
      description:
    ...
    {
      title: 'Feasibility and Resource Assessment',
      summary: 'Evaluate the feasibility of the selected ideas.',
      description:
      ...
      objective:
        'Determine which ideas are feasible and realistic to implement, ensuring they fit within resource constraints.',
    },
    {
      title: 'Final Concept Development and Presentation',
      summary: 'Develop the final concept and prepare for presentation.',
      description:
