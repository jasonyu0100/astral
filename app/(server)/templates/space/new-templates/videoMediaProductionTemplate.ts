  ...
  chapters: [
    {
      ...
      summary: 'Define the video’s purpose and target audience.',
      description:
    ...
    },
    {
      ...
      summary: 'Create a script and storyboard for the video.',
      description:
    ...
    },
    {
      ...
      summary: 'Organize resources and schedule the production.',
      description:
      ...
      objective:
        'Prepare thoroughly to facilitate a smooth production process and minimize potential issues.',
    },
    {
      title: 'Production Phase',
      summary: 'Shoot the video according to the script and storyboard.',
      description:
    ...
    },
    {
      ...
      summary: 'Edit the video to create a cohesive final product.',
      description:
    ...
    },
    {
      ...
      summary: 'Gather feedback and make necessary revisions.',
      description:
    ...
    },
    {
      ...
      summary: 'Conduct a final review and distribute the video.',
      description:
