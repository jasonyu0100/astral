...
import { postCommentModel, PostCommentObj } from '@/(server)/(model)/horizon/arc/forum/post/comment/main';
...
const useControllerForPostCommentList = (listId: string): Controller => {
