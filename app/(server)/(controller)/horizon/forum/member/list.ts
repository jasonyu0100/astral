...
import { forumMemberModel, ForumMemberObj } from '@/(server)/(model)/horizon/arc/forum/member/main';
...
const listIdKey = forumMemberModel.parentKey;
...
const useControllerForForumMemberList = (listId: string): Controller => {
...
const ContextForForumMemberList = createContext({} as Controller);
export { ContextForForumMemberList, useControllerForForumMemberList };
