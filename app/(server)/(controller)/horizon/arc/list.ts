...
import { horizonArcModel, HorizonArcObj } from '@/(server)/(model)/horizon/arc/main';
...
const listIdKey = horizonArcModel.parentKey;
...
const useControllerForHorizonArcList = (listId: string): Controller => {
...
const ContextForHorizonArcList = createContext({} as Controller);
export { ContextForHorizonArcList, useControllerForHorizonArcList };
