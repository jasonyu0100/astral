...
import {
  arcPointModel,
  ArcPointObj,
} from '@/(server)/(model)/horizon/arc/point/main';
...
const useControllerForArcPointList = (listId: string): Controller => {
...
const ContextForArcPointList = createContext({} as Controller);
export { ContextForArcPointList, useControllerForArcPointList };
