...
const useControllerForHorizonMemberList = (initialListId: string): Controller => {
...
const ContextForHorizonMemberList = createContext({} as Controller);
export { ContextForHorizonMemberList, useControllerForHorizonMemberList };
