...
const useControllerForSceneStackMain = (objId: string): Controller => {
...
const ContextForSceneStackMain = createContext({} as Controller);
export { ContextForSceneStackMain, useControllerForSceneStackMain };
