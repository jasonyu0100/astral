...
import {
  sceneStackModel,
  SceneStackObj,
} from '@/(server)/(model)/space/chapter/scene/stack/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = SceneStackObj;
const gqlDbWrapper = sceneStackDbWrapper;
const listIdKey = sceneStackModel.parentKey;
...
const useControllerForSceneStackList = (
  listId: string | boolean | number,
): Controller => {
...
const ContextForSceneStackList = createContext({} as Controller);
export { ContextForSceneStackList, useControllerForSceneStackList };
