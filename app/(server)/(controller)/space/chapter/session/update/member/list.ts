...
import {
  ChapterSessionMemberItemModel,
  ChapterSessionUpdateMemberObj,
} from '@/(server)/(model)/space/chapter/session/update/member/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = ChapterSessionUpdateMemberObj;
const gqlDbWrapper = ChapterSessionMemberDbWrapper;
const listIdKey = ChapterSessionMemberItemModel.parentKey;
