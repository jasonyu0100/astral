...
const useControllerForChapterChatList = (initialListId: string): Controller => {
...
const ContextForChapterChatList = createContext({} as Controller);
export { ContextForChapterChatList, useControllerForChapterChatList };
