...
const useControllerForSpaceUpdateMemberList = (initialListId: string): Controller => {
...
export { ContextForSpaceUpdateMemberList, useControllerForSpaceUpdateMemberList };
