...
import { UserBackerTermsObj } from '@/graphql/API';
...
const useControllerForUserBackerTermsMain = (objId: string): Controller => {
...
const ContextForUserBackerTermsMain = createContext({} as Controller);
export { ContextForUserBackerTermsMain, useControllerForUserBackerTermsMain };
