...
import {
  HorizonSessionContributorObj,
  horizonSessionContributorModel,
} from '@/(server)/model/horizon/session/contributor/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = HorizonSessionContributorObj;
const gqlDbWrapper = horizonSessionContributorDbWrapper;
const listIdKey = horizonSessionContributorModel.parentKey;
