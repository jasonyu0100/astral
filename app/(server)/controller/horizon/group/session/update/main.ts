import { horizonGroupSessionUpdateDbWrapper } from '@/(server)/client/horizon/group/session/update/main';
import {
  BaseCreateActions,
  BaseDeleteActions,
  BaseEditActions,
...
const useControllerForClusterUpdateListMain = (objId: string): Controller => {
