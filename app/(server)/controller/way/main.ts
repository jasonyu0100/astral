...
const useControllerForTaskMain = (objId: string): Controller => {
...
const ContextForTaskMain = createContext({} as Controller);
export {
  ContextForTaskMain as ContextForTaskMain,
  useControllerForTaskMain as useControllerForTaskMain,
};
