...
const useControllerForUserActivityMain = (objId: string): Controller => {
...
const ContextForUserActivityMain = createContext({} as Controller);
export { ContextForUserActivityMain, useControllerForUserActivityMain };
