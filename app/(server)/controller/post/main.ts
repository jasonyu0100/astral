...
const useControllerForUserPostMain = (objId: string): Controller => {
...
const ContextForUserPostMain = createContext({} as Controller);
export { ContextForUserPostMain, useControllerForUserPostMain };
