...
const useControllerForReviewCommentMain = (objId: string): Controller => {
...
const ContextForReviewCommentMain = createContext({} as Controller);
export { ContextForReviewCommentMain, useControllerForReviewCommentMain };
