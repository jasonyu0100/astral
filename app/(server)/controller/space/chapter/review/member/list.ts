import { reviewMemberDbWrapper } from '@/(server)/client/space/chapter/review/member/main';
import {
...
type TargetObj = ReviewMemberObj;
const gqlDbWrapper = reviewMemberDbWrapper;
const listIdKey = reviewMemberModel.parentKey;
...
const useControllerForReviewMemberList = (
  listId: string | boolean | number,
...
const ContextForReviewMemberList = createContext({} as Controller);
export { ContextForReviewMemberList, useControllerForReviewMemberList };
