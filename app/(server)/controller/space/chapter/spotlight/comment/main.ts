...
const useControllerForSpotlightCommentMain = (objId: string): Controller => {
...
const ContextForSpotlightCommentMain = createContext({} as Controller);
export { ContextForSpotlightCommentMain, useControllerForSpotlightCommentMain };
