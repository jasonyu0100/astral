...
import {
  spotlightCommentModel,
  SpotlightCommentObj,
} from '@/(server)/model/space/chapter/spotlight/comment/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = SpotlightCommentObj;
const gqlDbWrapper = spotlightCommentDbWrapper;
const listIdKey = spotlightCommentModel.parentKey;
...
const useControllerForSpotlightCommentList = (
  listId: string | boolean | number,
...
const ContextForSpotlightCommentList = createContext({} as Controller);
export { ContextForSpotlightCommentList, useControllerForSpotlightCommentList };
