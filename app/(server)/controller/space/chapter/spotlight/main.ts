...
const useControllerForChapterSpotlightMain = (objId: string): Controller => {
...
const ContextForChapterSpotlightMain = createContext({} as Controller);
export { ContextForChapterSpotlightMain, useControllerForChapterSpotlightMain };
