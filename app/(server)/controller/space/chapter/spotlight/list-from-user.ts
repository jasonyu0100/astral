...
const useControllerForChapterSpotlightListFromUser = (
  listId: string | boolean | number,
...
const ContextForChapterSpotlightListFromUser = createContext({} as Controller);
export {
  ContextForChapterSpotlightListFromUser,
  useControllerForChapterSpotlightListFromUser,
};
