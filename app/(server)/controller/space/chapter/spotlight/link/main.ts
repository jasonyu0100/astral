...
const useControllerForSpotlightLinkMain = (objId: string): Controller => {
...
const ContextForSpotlightLinkMain = createContext({} as Controller);
export { ContextForSpotlightLinkMain, useControllerForSpotlightLinkMain };
