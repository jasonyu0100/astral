...
import {
  spotlightLinkModel,
  SpotlightLinkObj,
} from '@/(server)/model/space/chapter/spotlight/link/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = SpotlightLinkObj;
const gqlDbWrapper = spotlightLinkDbWrapper;
const listIdKey = spotlightLinkModel.parentKey;
...
const useControllerForSpotlightLinkList = (
  listId: string | boolean | number,
...
const ContextForSpotlightLinkList = createContext({} as Controller);
export { ContextForSpotlightLinkList, useControllerForSpotlightLinkList };
