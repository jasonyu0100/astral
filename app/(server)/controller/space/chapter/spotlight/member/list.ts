import { spotlightMemberDbWrapper } from '@/(server)/client/space/chapter/spotlight/member/main';
import {
...
type TargetObj = SpotlightMemberObj;
const gqlDbWrapper = spotlightMemberDbWrapper;
const listIdKey = spotlightMemberModel.parentKey;
...
const useControllerForSpotlightMemberList = (
  listId: string | boolean | number,
...
const ContextForSpotlightMemberList = createContext({} as Controller);
export { ContextForSpotlightMemberList, useControllerForSpotlightMemberList };
