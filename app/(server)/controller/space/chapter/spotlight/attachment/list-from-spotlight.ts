...
} from '@/(server)/model/space/chapter/spotlight/attachment/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = SpotlightAttachmentObj;
const gqlDbWrapper = spotlightAttachmentDbWrapper;
const listIdKey = spotlightAttachmentModel.parentKey;
...
const useControllerForSpotlightAttachmentListFromSpotlight = (
  listId: string | boolean | number,
...
const ContextForSpotlightAttachmentListFromSpotlight = createContext(
  {} as Controller,
);
export {
  ContextForSpotlightAttachmentListFromSpotlight as ContextForSpotlightAttachmentListFromSpotlight,
  useControllerForSpotlightAttachmentListFromSpotlight as useControllerForSpotlightAttachmentListFromSpotlight,
};
