...
const useControllerForSpotlightAttachmentListFromUser = (
  listId: string | boolean | number,
...
const ContextForSpotlightAttachmentListFromUser = createContext(
  {} as Controller,
);
export {
  ContextForSpotlightAttachmentListFromUser,
  useControllerForSpotlightAttachmentListFromUser,
};
