...
const useControllerForSpotlightAttachmentMain = (objId: string): Controller => {
...
const ContextForSpotlightAttachmentMain = createContext({} as Controller);
export {
  ContextForSpotlightAttachmentMain,
  useControllerForSpotlightAttachmentMain,
};
