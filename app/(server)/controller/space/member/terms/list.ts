...
import {
  spaceMemberTermsModel,
  SpaceMemberTermsObj,
} from '@/(server)/model/space/member/terms/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = SpaceMemberTermsObj;
const gqlDbWrapper = spaceMemberTermsDbWrapper;
const listIdKey = spaceMemberTermsModel.parentKey;
...
const useControllerForSpaceMemberTermsList = (
  listId: string | boolean | number,
...
const ContextForSpaceMemberTermsList = createContext({} as Controller);
export { ContextForSpaceMemberTermsList, useControllerForSpaceMemberTermsList };
