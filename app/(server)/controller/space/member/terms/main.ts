...
const useControllerForSpaceMemberTermsMain = (objId: string): Controller => {
...
const ContextForSpaceMemberTermsMain = createContext({} as Controller);
export { ContextForSpaceMemberTermsMain, useControllerForSpaceMemberTermsMain };
