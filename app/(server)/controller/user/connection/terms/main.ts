...
const useControllerForUserConnectionTermsMain = (objId: string): Controller => {
...
const ContextForUserConnectionTermsMain = createContext({} as Controller);
export {
  ContextForUserConnectionTermsMain,
  useControllerForUserConnectionTermsMain,
};
