...
const useControllerForGalleryMemberMain = (targetId: string): Controller => {
...
const ContextForGalleryMemberMain = createContext({} as Controller);
export { ContextForGalleryMemberMain, useControllerForGalleryMemberMain };
