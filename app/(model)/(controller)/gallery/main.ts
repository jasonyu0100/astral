...
const useControllerForGalleryMain = (targetId: string): Controller => {
...
const ContextForGalleryMain = createContext({} as Controller);
export { ContextForGalleryMain, useControllerForGalleryMain };
