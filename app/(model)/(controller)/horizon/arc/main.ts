...
const useControllerForHorizonArcMain = (targetId: string): Controller => {
...
const ContextForHorizonArc = createContext({} as Controller);
export { ContextForHorizonArc, useControllerForHorizonArcMain };
