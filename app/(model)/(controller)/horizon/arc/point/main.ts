...
const useControllerForArcPointMain = (targetId: string): Controller => {
...
const ContextForArcPointMain = createContext({} as Controller);
export { ContextForArcPointMain, useControllerForArcPointMain };
