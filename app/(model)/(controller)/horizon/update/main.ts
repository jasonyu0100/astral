...
const useControllerForHorizonUpdateMain = (targetId: string): Controller => {
...
const ContextForHorizonUpdateMain = createContext({} as Controller);
export { ContextForHorizonUpdateMain, useControllerForHorizonUpdateMain };
