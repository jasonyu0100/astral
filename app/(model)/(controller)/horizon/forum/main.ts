...
const useControllerForArcForumMain = (targetId: string): Controller => {
...
const ContextForArcForumMain = createContext({} as Controller);
export { ContextForArcForumMain, useControllerForArcForumMain };
