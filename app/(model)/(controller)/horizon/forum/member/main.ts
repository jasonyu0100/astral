...
const useControllerForForumMemberMain = (targetId: string): Controller => {
...
const ContextForForumMemberMain = createContext({} as Controller);
export { ContextForForumMemberMain, useControllerForForumMemberMain };
