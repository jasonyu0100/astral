...
const useControllerForVerseCommentMain = (targetId: string): Controller => {
...
const ContextForVerseCommentMain = createContext({} as Controller);
export { ContextForVerseCommentMain, useControllerForVerseCommentMain };
