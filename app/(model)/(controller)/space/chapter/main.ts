...
const useControllerForSpaceChapterMain = (targetId: string): Controller => {
...
const ContextForSpaceChapterMain = createContext({} as Controller);
export { ContextForSpaceChapterMain, useControllerForSpaceChapterMain };
