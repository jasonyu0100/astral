...
const useControllerForChapterChatMain = (targetId: string): Controller => {
...
const ContextForChapterChatMain = createContext({} as Controller);
export { ContextForChapterChatMain, useControllerForChapterChatMain };
