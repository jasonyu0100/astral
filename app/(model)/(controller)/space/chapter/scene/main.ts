...
const useControllerForChapterSceneMain = (targetId: string): Controller => {
...
const ContextForChapterSceneMain = createContext({} as Controller);
export { ContextForChapterSceneMain, useControllerForChapterSceneMain };
