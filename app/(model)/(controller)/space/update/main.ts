...
const useControllerForSpaceUpdateMain = (targetId: string): Controller => {
...
const ContextForSpaceUpdateMain = createContext({} as Controller);
export { ContextForSpaceUpdateMain, useControllerForSpaceUpdateMain };
