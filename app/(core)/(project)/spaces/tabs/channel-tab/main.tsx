...
export function SpacesTabChannel({ tab }: { tab?: string }) {
  ...
  const url = spaceId
    ? `${spacesMap.spaces.id.channel.link(spaceId)}?chapter=${chapterId ?? ''}&scene=${sceneId ?? ''}`
