...
export function SpacesTabPreview({ tab }: { tab?: string }) {
  ...
  const url = spaceId
    ? `${spacesMap.spaces.id.preview.link(spaceId)}?chapter=${chapterId ?? ''}&post=${postId ?? ''}`
