...
import {
  ...
  useControllerForSpacesPublic,
} from './controller/main';
import { SpacesPublicModals } from './modal/controller/main';
import { SpacesPublicView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesPublicModals>{children}</SpacesPublicModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesPublic();
  return (
    <ContextForSpacesPublic.Provider value={flightController}>
      {children}
    </ContextForSpacesPublic.Provider>
  );
}
