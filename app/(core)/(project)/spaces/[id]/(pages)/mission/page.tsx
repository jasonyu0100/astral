...
import {
  ...
  useControllerForSpacesMission,
} from './controller/main';
import { SpacesMissionModals } from './modal/controller/main';
import { SpacesMissionView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesMissionModals>{children}</SpacesMissionModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const journeyController = useControllerForSpacesMission();

  return (
    <ContextForSpacesMission.Provider value={journeyController}>
      {children}
    </ContextForSpacesMission.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Mission} />
