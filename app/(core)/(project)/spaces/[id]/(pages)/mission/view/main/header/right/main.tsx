...
import { ContextForSpacesMission } from '../../../../controller/main';

export function SpacesMissionHeaderRight() {
  ...
  return (
    <div className='flex w-1/3 flex-row items-center justify-end'>
      {spacesMissionController.state.selectedTasks.length === 0 && (
      ...
      {spacesMissionController.state.selectedTasks.length > 0 && (
        ...
        >
          <p className='font-bold text-slate-300'>
            Generate Suggestion (
            {spacesMissionController.state.selectedTasks.length})
          </p>
