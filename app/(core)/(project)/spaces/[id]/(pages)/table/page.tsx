...
import {
  ...
  useControllerForSpacesTable,
} from './controller/main';
import { SpacesTableModals } from './modal/controller/main';
import { SpacesTableView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesTableModals>{children}</SpacesTableModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesTable();
  return (
    <ContextForSpacesTable.Provider value={flightController}>
      {children}
    </ContextForSpacesTable.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Table} />
