...
import { SpacesPagesCommentKarma } from './karma/main';
import { SpacesPagesCommentMessage } from './message/main';

export function SpacesPagesContentComment() {
      ...
      <ContextForCommentKarmaList.Provider value={commentKarma}>
        <GlassWindowFrame className='w-full'>
          <GlassWindowContents className='flex w-full flex-col space-y-[1rem]'>
            <SpacesPagesCommentMessage />
            <SpacesPagesCommentKarma />
          </GlassWindowContents>
        </GlassWindowFrame>
