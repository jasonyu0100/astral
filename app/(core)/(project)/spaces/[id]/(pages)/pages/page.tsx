...
import {
  ...
  useControllerForSpacesPages,
} from './controller/main';
import { SpacesPagesModals } from './modal/controller/main';
import { SpacesPagesView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesPagesModals>{children}</SpacesPagesModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesPages();
  return (
    <ContextForSpacesPages.Provider value={flightController}>
      {children}
    </ContextForSpacesPages.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Pages} />
