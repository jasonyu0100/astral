...
import { ContextForSpacesPosts } from '@/(core)/(project)/spaces/[id]/(pages)/updates/controller/main';
import { ContextForSpacesPostsModals } from '@/(core)/(project)/spaces/[id]/(pages)/updates/modal/controller/main';
...
export function SpacesPostsChapterPost() {
