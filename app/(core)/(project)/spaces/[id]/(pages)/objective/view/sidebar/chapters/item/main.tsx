...
export function SpacesObjectiveSidebarChaptersChapter() {
  const spacesObjectiveModalsController = useContext(
        ...
        >
          <GlassWindowContents className='flex flex-col space-y-[0.5rem]'>
            <div className='flex w-full flex-row items-center justify-between space-x-[1rem]'>
              ...
              <AstralMoreVertIcon
                onClick={() =>
                  spacesObjectiveModalsController.editChapterController.open()
                }
              />
            </div>
