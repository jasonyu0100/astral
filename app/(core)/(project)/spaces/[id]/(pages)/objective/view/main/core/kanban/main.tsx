...
export function SpacesObjectiveKanban() {
...
function KanbanTask({ task }) {
  ...
  const isSelected = spacesObjectiveController.state.selectedTasks.includes(
    task.id,
  );
    ...
    <div
      ...
      onClick={() => {
        if (isSelected) {
          ...
          spacesObjectiveController.actions.updateSelectedTasks(
            spacesObjectiveController.state.selectedTasks.filter(
              (id) => id !== task.id,
            ),
          );
        } else {
          ...
          spacesObjectiveController.actions.updateSelectedTasks([
            ...spacesObjectiveController.state.selectedTasks,
            task.id,
          ]);
        }
      }}
        ...
        <div className='flex flex-row space-x-[1rem]'>
          <button
            onClick={() => {
              ...
              spacesObjectiveController.actions.updateSidebarMode(
                SpacesObjectiveSidebarMode.BACKLOG,
              );
            }}
          >
