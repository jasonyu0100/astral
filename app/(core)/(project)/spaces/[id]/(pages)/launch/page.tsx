...
import {
  ...
  useControllerForSpacesLaunch,
} from './controller/main';
import { SpacesLaunchModals } from './modal/controller/main';
import { SpacesLaunchView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesLaunchModals>{children}</SpacesLaunchModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesLaunch();
  return (
    <ContextForSpacesLaunch.Provider value={flightController}>
      {children}
    </ContextForSpacesLaunch.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Launch} />
