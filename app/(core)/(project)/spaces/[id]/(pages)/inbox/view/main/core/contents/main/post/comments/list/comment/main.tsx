...
import { SpaceInboxCommentKarma } from './karma/main';
import { SpaceInboxCommentMessage } from './message/main';

export function SpaceInboxContentComment() {
      ...
      <ContextForCommentKarmaList.Provider value={commentKarma}>
        <GlassWindowFrame className='w-full'>
          <GlassWindowContents className='flex w-full flex-col space-y-[1rem]'>
            <SpaceInboxCommentMessage />
            <SpaceInboxCommentKarma />
          </GlassWindowContents>
        </GlassWindowFrame>
