...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesIdeasModals>{children}</SpacesIdeasModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const sceneController = useControllerForSpacesIdeas();
  const sceneChatController = useControllerForSpacesIdeasChat();

  return (
    <ContextForSpacesIdeas.Provider value={sceneController}>
      <ContextForSpacesIdeasChat.Provider value={sceneChatController}>
        {children}
      </ContextForSpacesIdeasChat.Provider>
    </ContextForSpacesIdeas.Provider>
  );
}
