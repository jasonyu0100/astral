...
export function SpacesIdeasMigrateSceneModal() {
  ...
  async function createScene() {
    ...
    setTimeout(() => {
      ...
      window.location.href = `${spacesMap.spaces.id.ideas.link(spaceController.state.objId)}?chapter=${chapterListController.state.objId}&scene=${sceneId}`;
    }, 1000);
  }
