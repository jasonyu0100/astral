...
import { SpacesChannelSidebarChaptersItemDescription } from './description/main';
import { SpacesChannelSidebarChapterItemTasks } from './tasks/main';
      ...
      {active ? (
        ...
        >
          <GlassWindowContents className='flex flex-col space-y-[1rem]'>
            <SpacesChannelSidebarChaptersItemDescription />
            <SpacesChannelSidebarChapterItemTasks />
          </GlassWindowContents>
