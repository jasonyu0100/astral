...
import {
  ...
  useControllerForSpacesLive,
} from './controller/main';
import { SpacesLiveModals } from './modal/controller/main';
import { SpacesLiveView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesLiveModals>{children}</SpacesLiveModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesLive();
  return (
    <ContextForSpacesLive.Provider value={flightController}>
      {children}
    </ContextForSpacesLive.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Live} />
