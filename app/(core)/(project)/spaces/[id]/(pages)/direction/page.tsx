...
import {
  ...
  useControllerForSpacesDirection,
} from './controller/main';
import { SpacesDirectionModals } from './modal/controller/main';
import { SpacesDirectionView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesDirectionModals>{children}</SpacesDirectionModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const journeyController = useControllerForSpacesDirection();

  return (
    <ContextForSpacesDirection.Provider value={journeyController}>
      {children}
    </ContextForSpacesDirection.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Direction} />
