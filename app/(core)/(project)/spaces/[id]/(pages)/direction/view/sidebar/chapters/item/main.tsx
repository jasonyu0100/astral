...
export function SpacesDirectionSidebarChaptersChapter() {
  const spacesDirectionModalsController = useContext(
        ...
        >
          <GlassWindowContents className='flex flex-col space-y-[0.5rem]'>
            <div className='flex w-full flex-row items-center justify-between space-x-[1rem]'>
              ...
              <AstralMoreVertIcon
                onClick={() =>
                  spacesDirectionModalsController.editChapterController.open()
                }
              />
            </div>
