...
export function SpacesDirectionKanban() {
...
function KanbanTask({ task }) {
  ...
  const isSelected = spacesDirectionController.state.selectedTasks.includes(
    task.id,
  );
    ...
    <div
      ...
      onClick={() => {
        if (isSelected) {
          ...
          spacesDirectionController.actions.updateSelectedTasks(
            spacesDirectionController.state.selectedTasks.filter(
              (id) => id !== task.id,
            ),
          );
        } else {
          ...
          spacesDirectionController.actions.updateSelectedTasks([
            ...spacesDirectionController.state.selectedTasks,
            task.id,
          ]);
        }
      }}
        ...
        <div className='flex flex-row space-x-[1rem]'>
          <button
            onClick={() => {
              ...
              spacesDirectionController.actions.updateSidebarMode(
                SpacesDirectionSidebarMode.BACKLOG,
              );
            }}
          >
