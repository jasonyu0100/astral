...
export function SpacesSceneSidebarScenesListActiveItem() {
  const {
    ...
    <GlassWindowFrame className='w-full p-[1rem]' roundedFx={roundedFx.rounded}>
      ...
      >
        ...
        <div
          ...
          onClick={() => {
            updateSidebarMode(SpacesSceneSidebarMode.IDEAS);
            updateDirectoryMode(SpacesSceneDirectoryMode.DEFAULT);
          }}
        >
          View Ideas
        </div>
