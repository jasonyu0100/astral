...
import {
  ...
  useControllerForSpacesPreview,
} from './controller/main';
import { SpacesPreviewModals } from './modal/controller/main';
import { SpacesPreviewView } from './view/main';
...
function ModalWrapper({ children }: { children: React.ReactNode }) {
  return (
    <>
      <SpacesPreviewModals>{children}</SpacesPreviewModals>
    </>
  );
}
...
function ControllerWrapper({ children }: { children: React.ReactNode }) {
  const flightController = useControllerForSpacesPreview();
  return (
    <ContextForSpacesPreview.Provider value={flightController}>
      {children}
    </ContextForSpacesPreview.Provider>
  );
}
  ...
  return (
    <DashboardContainer fullHeight>
      <SpacesSidebarModals>
        <SpacesSidebar />
        <DashboardContent>
          <SpaceTabs tab={SpaceTabStage.Preview} />
