...
interface ControllerState {
  sidebarVisibility: SpacesConversationSidebarVisibility;
  sidebarContentMode: SpacesConversationSidebarContentMode;
...
interface ControllerActions {
  ...
  updateSidebarVisibility: (
    visibility: SpacesConversationSidebarVisibility,
  ) => void;
  updateSidebarContentMode: (
    mode: SpacesConversationSidebarContentMode,
  ) => void;
...
export enum SpacesConversationSidebarVisibility {
  OPEN = 'Open',
  CLOSED = 'Closed',
}

export enum SpacesConversationSidebarContentMode {
  CHAPTERS = 'Chapters',
  MEMBERS = 'Members',
}
...
export const ContextForSpacesConversation = createContext({} as Controller);

export function useControllerForSpacesConversation() {
  ...
  const [sidebarContentMode, setSidebarContentMode] =
    useState<SpacesConversationSidebarContentMode>(
  ...
  const [sidebarVisibility, setSidebarVisibility] =
    useState<SpacesConversationSidebarVisibility>(
