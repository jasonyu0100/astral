...
import { SpacesPostsSidebarChaptersItemDescription } from './description/main';
import { SpacesPostsSidebarChapterItemTasks } from './tasks/main';

export function SpacesPostsSidebarChaptersChapter() {
      ...
      {selected ? (
        ...
        >
          <GlassWindowContents className='flex flex-col space-y-[1rem]'>
            <SpacesPostsSidebarChaptersItemDescription />
            <SpacesPostsSidebarChapterItemTasks />
          </GlassWindowContents>
