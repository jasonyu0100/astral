...
import { ContextForSpacesPosts } from '@/(core)/(project)/spaces/[id]/(pages)/posts/controller/main';
import { ContextForSpacesPostsModals } from '@/(core)/(project)/spaces/[id]/(pages)/posts/modal/controller/main';
