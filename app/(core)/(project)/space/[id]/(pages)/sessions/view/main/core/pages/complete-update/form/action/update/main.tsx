...
import { ContextForUpdateForm } from '@/(core)/(project)/space/[id]/(pages)/sessions/(controller)/complete-update-form/main';
import { ContextForSpaceSessionsController } from '@/(core)/(project)/space/[id]/(pages)/sessions/(controller)/space-session/main';
import { ContextForSessionUpdateOfChapterList } from '@/(server)/(controller)/space/chapter/session/update/chapter-list';
import { glassFx, roundedFx } from '@/(style)/data';
import { useContext } from 'react';

export function SpaceSessionsUpdateFormUpdate() {
