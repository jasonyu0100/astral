...
import { ContextForSessionForm } from '@/(core)/(project)/space/[id]/(pages)/sessions/(controller)/complete-session-form/main';
...
import { SpaceSessionsCollaboratorRow } from './row/main';

export function SpaceSessionsCollaboratorList() {
