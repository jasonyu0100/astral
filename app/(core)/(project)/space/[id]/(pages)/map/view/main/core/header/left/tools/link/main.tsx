import { SpaceMapAddUrlIdeaModal } from '@/(core)/(project)/space/[id]/(pages)/map/(modal)/add/idea/link/main';
import {
  ContextForOpenable,
...
export function SpaceMapLinkIcon({ ...props }: SvgInputProps) {
