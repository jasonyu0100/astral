...
import { SpaceFlightCommentKarma } from './karma/main';
import { SpaceFlightCommentMessage } from './message/main';

export function SpaceFlightContentComment() {
      ...
      <ContextForCommentKarmaList.Provider value={commentKarma}>
        <GlassWindowFrame className='w-full'>
          <GlassWindowContents className='flex w-full flex-col space-y-[1rem]'>
            <SpaceFlightCommentMessage />
            <SpaceFlightCommentKarma />
          </GlassWindowContents>
        </GlassWindowFrame>
