...
import { CreateSpacesCreateFromSourceModalFooter } from './footer/main';
import { CreateSpacesCreateFromSourceModalPages } from './pages/main';

export function CreateSpacesCreateFromSourceModalView() {
          ...
          <AstralModalBodyWrapper>
            <AstralModalBody>
              <AstralModalBodyContents>
                ...
                <CreateSpacesCreateFromSourceModalPages />
              </AstralModalBodyContents>
              <AstralModalBodyAction>
                <CreateSpacesCreateFromSourceModalFooter />
              </AstralModalBodyAction>
            </AstralModalBody>
          </AstralModalBodyWrapper>
        </AstralModal>
