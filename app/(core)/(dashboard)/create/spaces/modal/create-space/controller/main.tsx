...
interface CreateSpacesCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForCreateSpacesCreateSpace = createContext(
  {} as CreateSpacesCreateSpaceController,
);

export const useControllerForCreateSpacesCreateSpace =
  (): CreateSpacesCreateSpaceController => {
