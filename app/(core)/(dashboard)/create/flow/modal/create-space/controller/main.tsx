...
interface CreateFlowCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForCreateFlowCreateSpace = createContext(
  {} as CreateFlowCreateSpaceController,
);

export const useControllerForCreateFlowCreateSpace =
  (): CreateFlowCreateSpaceController => {
