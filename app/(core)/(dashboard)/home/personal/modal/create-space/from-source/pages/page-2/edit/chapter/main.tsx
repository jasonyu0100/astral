...
export function HomePersonalCreateFromSourceEditChapter() {
    ...
    >
      <div className='flex flex-row items-center'>
        ...
        <input
          ...
          onChange={(e) =>
            createSpaceController.actions.updateTemplateProjectChapters(
              createSpaceController.state.templateProjectChapters.map((c, i) =>
        ...
        {hoverableController.hovered && (
          <button
            ...
            onClick={() =>
              createSpaceController.actions.updateTemplateProjectChapters(
                createSpaceController.state.templateProjectChapters.filter(
                  (_, i) => i !== index,
                ),
              )
            }
