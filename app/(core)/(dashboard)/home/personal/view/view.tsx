    ...
    <>
      <div className='flex flex-col space-y-[2rem] py-[2rem]'>
        ...
        <div className='flex flex-row space-x-[2rem]'>
          ...
          <div className='flex h-[50px] w-[350px] cursor-pointer flex-row items-center justify-between rounded-full bg-gradient-to-br from-purple-500 to-violet-500 p-[1rem] p-[2rem]'>
            <p className='text-xl font-bold text-slate-300'>
