    ...
    <>
      <div className='flex flex-col space-y-[2rem] py-[2rem]'>
        ...
        <div className='flex flex-row space-x-[2rem]'>
          <div
            className='flex h-[50px] w-[300px] cursor-pointer flex-row items-center justify-between rounded-full bg-gradient-to-br from-blue-500 to-cyan-500 p-[1rem] p-[2rem]'
            onClick={() => {
          ...
          >
            ...
            <AstralAddIcon className='h-[2rem] w-[2rem]' />
          </div>
          {/* <div className='flex h-[50px] w-[300px] cursor-pointer flex-row items-center justify-between rounded-full bg-gradient-to-br from-purple-500 to-violet-500 p-[1rem] p-[2rem]'>
