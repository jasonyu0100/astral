...
interface HomeCampaignCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForHomeCampaignCreateSpace = createContext(
  {} as HomeCampaignCreateSpaceController,
);

export const useControllerForHomeCampaignCreateSpace =
  (): HomeCampaignCreateSpaceController => {
