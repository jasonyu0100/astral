...
import { ContextForHomeCreateModals } from '../modal/controller/main';
import { ContextForHomeCreateCreateSpace } from '../modal/create-space/controller/main';
import { HomeCreateTableMain } from './flow/main';

export function HomeCreateView() {
  const homePersonalModalsController = useContext(ContextForHomeCreateModals);
