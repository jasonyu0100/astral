...
import { HomeProjectsCreateFromSourceModalFooter } from './footer/main';
import { HomeProjectsCreateFromSourceModalPages } from './pages/main';

export function HomeProjectsCreateFromSourceModalView() {
          ...
          <AstralModalBodyWrapper>
            <AstralModalBody>
              <AstralModalBodyContents>
                ...
                <HomeProjectsCreateFromSourceModalPages />
              </AstralModalBodyContents>
              <AstralModalBodyAction>
                <HomeProjectsCreateFromSourceModalFooter />
              </AstralModalBodyAction>
            </AstralModalBody>
          </AstralModalBodyWrapper>
        </AstralModal>
