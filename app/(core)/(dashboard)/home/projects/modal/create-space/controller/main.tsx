...
interface HomeProjectsCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForHomeProjectsCreateSpace = createContext(
  {} as HomeProjectsCreateSpaceController,
);

export const useControllerForHomeProjectsCreateSpace =
  (): HomeProjectsCreateSpaceController => {
