...
interface HomeFlowCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForHomeFlowCreateSpace = createContext(
  {} as HomeFlowCreateSpaceController,
);

export const useControllerForHomeFlowCreateSpace =
  (): HomeFlowCreateSpaceController => {
