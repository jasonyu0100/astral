...
interface FlowCurrentCreateSpaceController {
  actions: ControllerActions;
  state: ControllerState;
}

export const ContextForFlowCurrentCreateSpace = createContext(
  {} as FlowCurrentCreateSpaceController,
);

export const useControllerForFlowCurrentCreateSpace =
  (): FlowCurrentCreateSpaceController => {
