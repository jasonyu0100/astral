import { useControllerForSpaceSessionUpdateList } from '@/(server)/(controller)/space/chapter/session/update/space-list';
...
export function StudioSpacesRowStat() {
  ...
  const sessionUpdateListController = useControllerForSpaceSessionUpdateList(
    spaceObj.id,
  );
