import { useControllerForPostKarmaList } from '@/architecture/controller/post/karma/list';
...
export function PublicSpaceChapterPostKarma() {
  const postObj = useContext(ContextForUserPostObj);
  const loggedInUser = useContext(ContextForLoggedInUserObj);
  const postKarmaListController = useControllerForPostKarmaList(postObj.id);
