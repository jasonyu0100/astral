...
export function PublicSpaceBreadcrumbsChat() {
  ...
  console.log(userMainController.state.obj);
  ...
  return (
    <div className='flex flex-shrink-0 flex-row justify-between pr-[1rem]'>
      ...
      <Link
        href={`${spacesMap.spaces.id.channel.link(spaceMainController.state.objId)}?chapter=${chapterListController.state.currentObj?.id}`}
      >
