...
import {
  ProfileModalContext,
  useProfileModal,
} from '@/(core)/(modals)/profile-modal/main';
import { ProfileModalView } from '@/(core)/(modals)/profile-modal/view';
import {
  SettingsModalContext,
  useSettingsModal,
} from '@/(core)/(modals)/settings-modal/main';
import { SettingsModalView } from '@/(core)/(modals)/settings-modal/view';
