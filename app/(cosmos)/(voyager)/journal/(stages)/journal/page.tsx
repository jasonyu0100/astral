...
import { FeedMomentHandler, useFeedMoments } from '@/(cosmos)/handler/feed-moments/main';
...
function Page() {
  ...
  const { momentId, moments, _momentHandler } = useFeedMoments(state.user.id, MomentVisibility.JOURNAL);
