...
import { flowModel, FlowObj } from '@/architecture/model/flow/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = FlowObj;
const gqlDbWrapper = flowDbWrapper;
const listIdKey = flowModel.parentKey;
...
export const useControllerForFlowList = (
  listId: string | boolean | number,
...
export const ContextForFlowList = createContext({} as Controller);
