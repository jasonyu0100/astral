...
import { UserPostObj, UserPostStatus } from '@/architecture/model/post/main';
...
export const useControllerForUserPostListFromSpace = (
  listId: string | boolean | number,
...
export const ContextForUserPostListFromSpace = createContext({} as Controller);
