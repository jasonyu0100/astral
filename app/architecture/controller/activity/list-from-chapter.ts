...
import {
  UserActivityObj,
  UserActivityVariant,
} from '@/architecture/model/activity/main';
...
export const useControllerForUserActivityListFromChapter = (
  listId: string | boolean | number,
...
export const ContextForUserActivityListFromChapter = createContext(
  {} as Controller,
);
