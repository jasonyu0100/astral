import { quadrantMemberDbWrapper } from '@/architecture/client/horizon/decision/quadrant/member/main';
import {
...
import {
  quadrantMemberModel,
  QuadrantMemberObj,
} from '@/architecture/model/horizon/decision/quadrant/member/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = QuadrantMemberObj;
const gqlDbWrapper = quadrantMemberDbWrapper;
const listIdKey = quadrantMemberModel.parentKey;
...
export const useControllerForQuadrantMemberList = (
  listId: string | boolean | number,
