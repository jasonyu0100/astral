import { horizonDecisionDbWrapper } from '@/architecture/client/horizon/decision/main';
import {
  BaseCreateActions,
  BaseDeleteActions,
  BaseEditActions,
...
import { HorizonDecisionObj } from '@/architecture/model/horizon/decision/main';
...
export const useControllerForHorizonDecisionMain = (
  objId: string,
): Controller => {
...
export const ContextForHorizonDecisionMain = createContext({} as Controller);
