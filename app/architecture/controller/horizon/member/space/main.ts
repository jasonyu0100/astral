import { horizonSpaceMemberDbWrapper } from '@/architecture/client/horizon/member/space/main';
import {
  BaseCreateActions,
  BaseDeleteActions,
  BaseEditActions,
...
import { HorizonSpaceMemberObj } from '@/architecture/model/horizon/member/space/main';
...
export const useControllerForHorizonSpaceMemberMain = (
  objId: string,
): Controller => {
...
export const ContextForHorizonSpaceMemberMain = createContext({} as Controller);
