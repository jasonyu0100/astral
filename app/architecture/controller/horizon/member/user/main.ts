...
import { HorizonUserMemberObj } from '@/architecture/model/horizon/member/user/main';
...
export const useControllerForHorizonUserMemberMain = (
  objId: string,
): Controller => {
...
export const ContextForHorizonUserMemberMain = createContext({} as Controller);
