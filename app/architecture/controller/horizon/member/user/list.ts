import { horizonUserMemberDbWrapper } from '@/architecture/client/horizon/member/user/main';
import {
...
import {
  horizonUserMemberModel,
  HorizonUserMemberObj,
} from '@/architecture/model/horizon/member/user/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = HorizonUserMemberObj;
const gqlDbWrapper = horizonUserMemberDbWrapper;
const listIdKey = horizonUserMemberModel.parentKey;
...
export const useControllerForHorizonUserMemberList = (
  listId: string | boolean | number,
...
export const ContextForHorizonUserMemberList = createContext({} as Controller);
