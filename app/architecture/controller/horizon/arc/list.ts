import { horizonArcDbWrapper } from '@/architecture/client/horizon/arc/main';
import {
...
export const useControllerForHorizonArcList = (
  listId: string | boolean | number,
