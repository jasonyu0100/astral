...
import { galleryModel, GalleryObj } from '@/architecture/model/gallery/main';
...
export const useControllerForGalleryList = (
  listId: string | boolean | number,
  ...
  const createActions: CreateActions = {
    createGallery: async (userId, title, description, thumbnail) => {
...
export const ContextForGalleryList = createContext({} as Controller);
