...
} from '@/architecture/model/gallery/collection/main';
import { createContext, useMemo, useState } from 'react';

type TargetObj = GalleryCollectionObj;
const gqlDbWrapper = galleryCollectionDbWrapper;
const listIdKey = galleryCollectionModel.parentKey;
...
export const useControllerForGalleryCollectionList = (
  listId: string | boolean | number,
...
export const ContextForGalleryCollectionList = createContext({} as Controller);
