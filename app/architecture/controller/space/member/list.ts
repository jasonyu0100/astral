...
import {
  spaceMemberModel,
  SpaceMemberObj,
} from '@/architecture/model/space/member/main';
...
export const useControllerForSpaceMemberList = (
  listId: string | boolean | number,
...
export const ContextForSpaceMemberList = createContext({} as Controller);
