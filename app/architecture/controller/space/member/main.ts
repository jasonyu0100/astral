...
import { SpaceMemberObj } from '@/architecture/model/space/member/main';
...
export const useControllerForSpaceMemberMain = (objId: string): Controller => {
...
export const ContextForSpaceMemberMain = createContext({} as Controller);
