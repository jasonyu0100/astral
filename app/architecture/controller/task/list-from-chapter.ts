...
export const useControllerForTaskListFromChapter = (
  listId: string | boolean | number,
  ...
  const createActions: CreateActions = {
    ...
    createTask: async (chapterId, userId, title, description, spaceId) => {
      const createObj: Omit<TargetObj, 'id'> = {
        created: new Date().toISOString(),
        userId: userId,
        chapterId: chapterId,
...
export const ContextForTaskListFromChapter = createContext({} as Controller);
