    ...
    <DashboardGuideWrapper>
      ...
      <DashboardGuideContainer>
        <div className="w-full overflow-auto flex flex-col space-y-[50px] py-[60px] p-[30px]">
          <p className="text-slate-500 text-xl font-bold uppercase">NATURE</p>
          <p className="text-slate-500 text-xl font-bold uppercase">OCEAN</p>
          <p className="text-slate-500 text-xl font-bold uppercase">CITY</p>
        </div>
      </DashboardGuideContainer>
    </DashboardGuideWrapper>
  );
