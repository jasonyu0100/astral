...
export function DashboardSidebar({ indicator }: SidebarProps) {
  return (
    <div className="w-[15rem] h-full flex flex-col flex-shrink-0 space-y-[2.5rem] px-[2rem] pt-[2rem] pb-[1rem] overflow-y-auto relative bg-gradient-to-br from-slate-800 to-slate-900">
      <SidebarCurrentWork>
        <SidebarWorkCover active={!indicator} />
        <SidebarWorkInfo active={!indicator} />
      </SidebarCurrentWork>
      <div className="w-full h-[0px] border border-slate-400 border-opacity-30"></div>
      <SidebarIndicators>
