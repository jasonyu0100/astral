...
import { Tab } from '@/(verses)/(common)/tabs/tabs-row/tab/main';
import { TabOrangeShard } from '@/(verses)/(common)/tabs/tabs-row/tab/shard/orange/main';
import { TabText } from '@/(verses)/(common)/tabs/tabs-row/tab/text/main';
