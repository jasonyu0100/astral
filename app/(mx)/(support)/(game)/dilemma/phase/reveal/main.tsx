export function PhaseReveal() {
  return (
    <div className='flex flex-col space-y-[1rem]'>
      ...
      <div className='flex flex-col'>
        <div className='flex flex-col'>
          <p className='text-md font-bold text-slate-500'>A - (Q) and (5)</p>
          <p className='text-md font-bold text-slate-500'>
            sum(12, 5) = 17, max(12, 5) = P1
          </p>
        </div>
        <div className='flex flex-col'>
          <p className='text-md font-bold text-slate-500 '>P - (P) and (3,2)</p>
          <p className='text-md font-bold text-slate-500 '>
            sum(11, 5) = 16, max(11, 5) = P1
          </p>
        </div>
        <div className='flex flex-col'>
          <p className='text-md font-bold text-slate-500'>B - (A, K) and (4)</p>
          <p className='text-md font-bold text-slate-500'>
