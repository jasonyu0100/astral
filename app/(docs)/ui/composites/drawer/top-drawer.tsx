  ...
  return (
    <>
      ...
      <div className="text-center">
        <button
          className="overflow-y-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
          type="button"
      ...
      <div
        ...
        className="top-0 left-0 right-0 z-40 w-full p-4 transition-transform -translate-y-full bg-white dark:bg-gray-800"
        tabIndex={-1}
      ...
      >
        ...
        <p className="max-w-lg mb-6 text-sm text-gray-500 dark:text-gray-400">
          ...
          for Ouros Docs + Job Board. Unlimited access to over 190K
