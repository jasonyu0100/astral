export default function ButtonGroupBottomNavigation() {
  return (
    <div
      ...
      className="bottom-0 z-50 w-full -translate-x-1/2 bg-white border-t border-gray-200 left-1/2 dark:bg-gray-700 dark:border-gray-600"
    >
