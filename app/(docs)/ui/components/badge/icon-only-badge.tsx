export default function IconOnlyBadge() {
  return (
    <>
      ...
      <span className="bg-blue-100 text-blue-800 text-sm font-semibold inline-flex items-center p-1.5 rounded-full dark:bg-gray-700 dark:text-blue-400">
        <svg
          aria-hidden="true"
          className="w-3.5 h-3.5"
          fill="currentColor"
