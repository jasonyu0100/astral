export default function FullWidthNavCard() {
  return (
        ...
        >
          ...
          >
            ...
            >
              <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  Ouros is an open-source library of interactive components
            ...
            >
              <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  Ouros is first conceptualized and designed using the Figma
            ...
            <h2 id="accordion-flush-heading-3">
              ...
              >
                <span>
                  What are the differences between Ouros and Tailwind UI?
                </span>
                <svg
                  data-accordion-icon=""
                  className="w-6 h-6 shrink-0"
            ...
            >
              <div className="py-5 border-b border-gray-200 dark:border-gray-700">
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  The main difference is that the core components from Ouros
                  are open source under the MIT license, whereas Tailwind UI is
                  a paid product. Another difference is that Ouros relies on
                  smaller and standalone components, whereas Tailwind UI offers
                  sections of pages.
                </p>
                <p className="mb-2 text-gray-500 dark:text-gray-400">
                  However, we actually recommend using both Ouros, Ouros
