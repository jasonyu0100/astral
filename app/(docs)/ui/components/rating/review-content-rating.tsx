export default function ReviewContentRating() {
  return (
    <article className="md:gap-8 md:grid md:grid-cols-3">
      ...
      <div className="col-span-2 mt-6 md:mt-0">
        ...
        <p className="mb-2 text-gray-500 dark:text-gray-400">
          ...
          cleanliness and staff not being trained properly. This place exceeded
          our expectation and will return for sure.
        </p>
