export default function BorderAccentAlert() {
  return (
    <>
      <div
        id="alert-border-1"
      ...
      <div
        id="alert-border-5"
        className="flex p-4 border-t-4 border-gray-300 bg-gray-50 dark:bg-gray-800 dark:border-gray-600"
        role="alert"
      >
        <svg
          className="flex-shrink-0 w-5 h-5 text-gray-800 dark:text-gray-300"
          fill="currentColor"
          viewBox="0 0 20 20"
          xmlns="http://www.w3.org/2000/svg"
        >
        ...
        <div className="ml-3 text-sm font-medium text-gray-800 dark:text-gray-300">
          ...
          <a
            href="#"
            className="font-semibold underline hover:text-gray-800 hover:no-underline"
          >
            example link
          </a>
          . Give it a click if you like.
