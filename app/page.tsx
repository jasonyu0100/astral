      ...
      <div className='relative h-1/2 w-full'>
        <div className='absolute z-50 h-full w-full'>
          <div className='absolute left-[0px] top-[100px] h-[200px] w-[200px] bg-yellow-500 p-[1rem] shadow-glow'>
            <p className='font-bold'>- research marketing trends</p>
            <p className='font-bold'>- contact agency</p>
            <p className='font-bold'>- finalise landing page</p>
          </div>
          <div className='absolute left-[1300px] top-[200px] h-[200px] w-[200px] bg-yellow-500 p-[1rem] shadow-glow'>
            <p className='font-bold'>
              The generative AI wave shows great promise
            </p>
          </div>
          ...
          <div className='absolute left-[700px] top-[450px] h-[200px] w-[200px]'>
            <p className='text-3xl font-bold text-slate-300'>
              I need to get work done
            </p>
          </div>
          <div className='absolute left-[300px] top-[0px] h-[200px] w-[200px]'>
            <div className='flex flex-row items-center space-x-[0.5rem]'>
              <AstralFileIcon />
              <p className='text-3xl font-bold text-slate-300'>file.mp3</p>
            </div>
          </div>
          <div className='absolute left-[250px] top-[400px] h-[100px] w-[100px]'>
            <img
              src='/brand/avatar.jpeg'
              className='h-full w-full rounded-full'
            />
          </div>
          <div className='absolute left-[1000px] top-[400px] h-[150px] w-[150px]'>
            <img
              src='/portal/artist-f.png'
              className='h-full w-full rounded-full'
            />
          </div>
