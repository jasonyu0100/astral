  ...
  return (
    <>
      {isDesktop && (
        <div
          className={cn(
            'flex h-[600px] w-full flex-col items-center justify-center',
          )}
        >
              ...
              <div className='absolute left-[1200px] top-[200px] h-[200px] w-[300px]'>
                ...
                >
                  <GlassWindowContents className='flex h-full w-full animate-pulse-slow flex-col overflow-hidden rounded-lg bg-slate-950 bg-opacity-50 p-4 text-lg font-light text-slate-300'>
                    "It’s the iteration of ideas with a goal in mind, that moves
                    a project forward."
                  </GlassWindowContents>
...
function FAQSection() {
  const faqData = [
    ...
    },
    {
      ...
      answer:
        'Astral is priced at $20 per month, offering an end-to-end solution for creative collaboration.',
    },
    {
