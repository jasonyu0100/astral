import { StarTemplateObj } from '@/(logic)/internal/data/infra/model/draft/constellation/star/main';
...
import { MessageTemplateObj } from '@/(logic)/internal/data/infra/model/storm/chat/message/main';
