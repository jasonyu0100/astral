...
import { exampleFile, exampleFiles } from '@/(logic)/internal/data/infra/model/resource/file/main';
import { ResourceVariant } from '@/(logic)/internal/data/infra/model/resource/main';
import { MessageSource } from '@/(logic)/internal/data/infra/model/storm/chat/message/main';
