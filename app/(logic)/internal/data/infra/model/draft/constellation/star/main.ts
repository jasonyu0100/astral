import { FileObj, exampleFile } from '@/(logic)/internal/data/infra/model/resource/file/main';
...
import { ScoreObj } from '@/(logic)/internal/data/infra/model/resource/score/main';
